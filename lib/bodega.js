...
var BodegaManager = (function() {
    ...
    */
    ...
    BodegaManager.prototype.connect = function(url, cb, req, res) {
        ...
        if (req.method !== 'GET' && req.path.indexOf('json') !== -1) {
    ...
    BodegaManager.prototype.assetStats = function(req, res) {
        this.connect(assetStats.requestUrl, assetStats.communicate, req, res);
    };

    BodegaManager.prototype.jsonProxy = function(req, res) {
        this.connect(jsonProxy.requestUrl, jsonProxy.communicate, req, res);
    };
